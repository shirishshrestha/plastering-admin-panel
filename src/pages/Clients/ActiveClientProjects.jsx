...
import { useGetClientActiveProjects } from "./hooks/query/useGetClientActiveProjects.js";
...
export const ActiveClientProjects = () => {
  ...
  const {
    data: RecentActiveProjectData,
    isPending: RecentActiveProjectsPending,
  ...
  const { data: ActiveProjectData, isPending: ActiveProjectPending } =
    useGetClientActiveProjects(
      "userActiveProjects",
      "/clientProjects/activeClientProjects",
      currentPage,
      searchItem
    );
  ...
  return (
    <>
      <section>
        {(ActiveProjectPending ||
          RecentActiveProjectsPending ||
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="overflow-hidden h-full flex flex-col items-center">
            ...
            <SwiperComponent
              ...
              className="mySwiper"
            >
              {RecentActiveProjectData?.projects?.data?.length > 0 ? (
                RecentActiveProjectData?.projects?.data?.map((project) => (
        ...
        <div className="pt-[2rem] pb-[1rem]">
          ...
          <table className="w-full bg-white shadow-md rounded-lg overflow-hidden capitalize">
            ...
            <tbody className="">
              {ActiveProjectData?.projects?.data.length > 0 ? (
                ActiveProjectData?.projects?.data.map((item) => (
        ...
        {ActiveProjectData?.projects?.last_page > 1 && (
